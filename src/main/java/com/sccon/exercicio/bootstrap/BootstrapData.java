...
public class BootstrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Person joao = new Person(2L, "Bruno dos Santos", LocalDate.of(2001, 5, 1), LocalDate.of(2021, 6, 1));
        Person jeremias = new Person(3L, "Alice de Jesus",LocalDate.of(2001, 7, 1), LocalDate.of(2022, 5, 1));
